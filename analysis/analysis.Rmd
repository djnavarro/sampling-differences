...
sampling_frames_model(tau = 2, rho = .5, sigma = 1, mu = .05) %>% 
  model_plot()
```
...
The model prediction is that if people are sensitive to the sampling manipulation, they will show that interaction pattern. 
